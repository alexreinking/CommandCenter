...
Vector3D IMUDecoder::getSpaceAcceleration() const
{
    return currentCalcData.spaceAccel;
}
...
Vector3D IMUDecoder::getSpaceIntegratedVelocity() const
{
    return currentCalcData.spaceVel;
}
...
Vector3D IMUDecoder::getSpaceIntegratedPosition() const
{
    return currentCalcData.spacePos;
}
...
printf("Acceleration: X: %f, Y: %f, Z: %f", currentCalcData.accel.coordX,currentCalcData.accel.coordY,currentCalcData.accel.coordZ);
printf("     Velocity: X: %f, Y: %f, Z: %f\n", currentCalcData.vel.coordX,currentCalcData.vel.coordY,currentCalcData.vel.coordZ);
printf("Position: X: %f, Y: %f, Z: %f", currentCalcData.pos.coordX,currentCalcData.pos.coordY,currentCalcData.pos.coordZ);
